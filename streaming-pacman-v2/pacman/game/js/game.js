...
function produceRecord(topic, record) {
	...
	var ksqlQuery = {};
	ksqlQuery.ksql =`INSERT INTO USER_GAME (USER, GAME) VALUES ('${record.user}', STRUCT(SCORE:=${record.game.score},LIVES:=${record.game.lives},LEVEL:=${record.game.level}));`

	const request = new XMLHttpRequest();
	request.open("POST", KSQLDB_QUERY_API, true, KSQLDB_USER, KSQLDB_PASSWORD);
